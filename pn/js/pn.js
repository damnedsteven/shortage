...
{ 
	this.editableGrid = new EditableGrid("pn", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=pn");
};
...
// render for the action column
	grid.setCellRenderer("action", new CellRenderer({ 
		render: function(cell, id) {                 
			  ...
			  cell.innerHTML+= "&nbsp;&nbsp;<i onclick=\"datagrid.duplicateRow("+id+");\" class='fa fa-copy' ></i>";
		}
	})); 
...
DatabaseGrid.prototype.duplicateRow = function(id) 
{
  ...
  if ( confirm('Duplicate the row id ' + id )  ) {
